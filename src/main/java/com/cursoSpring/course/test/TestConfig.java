package com.cursoSpring.course.test;
...
import com.cursoSpring.course.entities.Payment;
import com.cursoSpring.course.entities.Product;
import com.cursoSpring.course.entities.User;
import com.cursoSpring.course.enuns.OrderStatus;
import com.cursoSpring.course.repository.CategoryRepository;
import com.cursoSpring.course.repository.OrderItemRepository;
import com.cursoSpring.course.repository.OrderRepository;
import com.cursoSpring.course.repository.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	@Autowired
	private CategoryRepository cotegoreRepository;
	...
	public void run(String... args) throws Exception {
		...
		cotegoreRepository.saveAll(Arrays.asList(cat1, cat2, cat3));
